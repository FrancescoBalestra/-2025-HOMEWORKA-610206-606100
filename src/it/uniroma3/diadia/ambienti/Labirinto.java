...
public class Labirinto {
	...
	public static class LabirintoBuilder {
		...
		public LabirintoBuilder addAdiacenza(String nomeStanza, String nomeAdiacente, String direz) {
			if(stanze.isEmpty() || !stanze.containsKey(nomeStanza) || !stanze.containsKey(nomeAdiacente) || stanze.get(nomeStanza).getNumeroStanzeAdiacenti()==4) return this;
		...
		public LabirintoBuilder addCane(String stanza, String nome, String presentazione, String cibo, Attrezzo att) {
			...
			stanze.get(stanza).setPersonaggio(new Cane(nome, presentazione));
			return this;
		}
		...
		public LabirintoBuilder addCane(String nome, String presentazione, String cibo, Attrezzo att) {
			...
			stanze.get(nomeStanzaCorrente).setPersonaggio(new Cane(nome, presentazione));
			return this;
		}
