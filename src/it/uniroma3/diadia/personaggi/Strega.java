...
public class Strega extends AbstractPersonaggio{
	...
	private static final String MESSAGGIO_RISATA = "Mi hai dato un regalo hahahha";//Proprietà.getMessaggioRisata();
	private static final String MESSAGGIO_NON_SALUTATA = "Non mi hai salutata";//Proprietà.getMessaggioNonSalutata();
	private static final String MESSAGGIO_INGANNO = "te lo butto in quel posto";//Proprietà.getMessaggioInganno();
